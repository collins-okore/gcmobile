...
export const SECURITY_GUARD_GUEST_URLS = {
  GET_ALL: `/security-guards/guests`,
  GET_ONE: (id: string) => `/security-guards/guests/${id}`,
  CREATE: `/security-guards/guests`,
  UPDATE: (id: string) => `/security-guards/guests/${id}`,
  DELETE: (id: string) => `/security-guards/guests/${id}`,
  MARK_AS_ARRIVED: (id: string) =>
    `/security-guards/guests/${id}/mark-as-arrived`,
  MARK_AS_DEPARTED: (id: string) =>
    `/security-guards/guests/${id}/mark-as-departed`,
  MARK_AS_CANCELLED: (id: string) =>
    `/security-guards/guests/${id}/mark-as-cancelled`,
};

// Security Guard Check In URLs
export const SECURITY_GUARD_CHECK_IN_URLS = {
  SEARCH: (query: string) =>
    `/security-guards/security-check-in?query=${query}`,
};

// Security Guard Residents URLs
export const SECURITY_GUARD_RESIDENT_URLS = {
  GET_ALL: `/security-guards/residents`,
  GET_ONE: (id: string) => `/security-guards/residents/${id}`,
};
